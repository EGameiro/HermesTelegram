...
Tabelas: `Usuarios`, `TelegramVinculos`, `Planos`, `Assinaturas`, `Pagamentos`,
`UsoMensal`, `Configuracoes`, `ContasPagar`, `Compromissos`, `HistoricoConversa`.
...
1. Painel gera `TokenVinculo` (curto, com `TokenExpiraEm`) na `TelegramVinculos` do usuário.
